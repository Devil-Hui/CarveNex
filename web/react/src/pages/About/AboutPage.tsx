...
const AboutPage: React.FC = () => {
  ...
  return (
    <AboutContainer>
      ...
      <Section id="about">
        <SectionTitle>About CarveNex</SectionTitle>
        <Paragraph>
          CarveNex is a leading enterprise e-commerce platform dedicated to providing
        ...
        <Paragraph>
          With a commitment to quality, reliability, and customer satisfaction, CarveNex
      ...
      <Section id="terms">
        ...
        <Paragraph>
          By using the CarveNex platform, you agree to our Terms of Service. These terms
      ...
      <Section id="help">
        ...
        <Paragraph>
          Email us at support@carvenex.com or visit our Help Center for FAQs,
