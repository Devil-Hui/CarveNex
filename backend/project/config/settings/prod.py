...
# 跨子域会话：csrftoken / sessionid cookie 落在父域 .carvenex.com，
# 使 admin/www/shop 页面都能读到 csrftoken 并随 axios 写请求回传（否则 host-only cookie 读不到 → 403 CSRF Failed）
CSRF_COOKIE_DOMAIN = '.carvenex.com'
SESSION_COOKIE_DOMAIN = '.carvenex.com'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://shop.carvenex.com',
    'https://api.carvenex.com',
    'https://carvenex.huigeli666.workers.dev',
