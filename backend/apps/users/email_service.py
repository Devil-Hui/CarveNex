...
def _render_template(template_type: str, context: dict) -> dict:
    ...
    if template_type == 'admin_welcome':
        platform_name = context.get('platform_name', 'CarveNex')
    ...
    return {
        'subject': 'CarveNex - Email Verification',
  ...
  <div style="display:flex;align-items:center;gap:10px;margin-bottom:24px;">
    ...
    <div style="font-size:22px;font-weight:600;letter-spacing:-0.5px;">CarveNex</div>
  </div>
  ...
  <div style="border-top:1px solid #eee;margin-top:24px;padding-top:16px;font-size:11px;color:#aaa;text-align:center;">
    CarveNex · Automated message. Please do not reply.
  </div>
</div>''',
